...
window.iconbitmap('Football.ico') #adding icon in title
# create frame
...
def next():
    ...
    try:
        ...
        next()
# create buttons    
btn1 = Button(window, text="Previous",width=8, bd=5,bg='white', fg='Blue', font=('cambria 15 bold'), relief=RAISED, command=previous)
btn1.pack(side=LEFT, padx=60, pady=5)
btn3 = Button(window, text="Exit", width=8,bd=5, bg='white', fg='Blue', font=('cambria 15 bold'), relief=RAISED, command=window.destroy)
btn3.pack(side=LEFT, padx=60, pady=5)
btn2 = Button(window, text="Next", width=8, bd=5,bg='white', fg='Blue', font=('cambria 15 bold'), relief=RAISED, command=next)
